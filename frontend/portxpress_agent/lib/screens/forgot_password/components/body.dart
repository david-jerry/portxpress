...
import 'package:portxpress_agent/components/no_account_text.dart';
          ...
          RaisedButton(
            ...
            onPressed: () {
              if (_formKey.currentState.validate() &&
                ...
                _firebaseuser.sendPasswordResetEmail(
                    email: emailTextEditingController.text.trim());
                deisplayToastMsg(
                    "Password Reset Email Sent.", kPrimaryColor, context);
                Navigator.pushNamed(context, SignInScreen.routeName);
              } else {
                deisplayToastMsg(
                    "Password Reset Sending Failed.", kDangerColor, context);
              }
            },
          ),
          SizedBox(height: SizeConfig.screenHeight * 0.1),
